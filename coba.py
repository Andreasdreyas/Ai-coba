...
# Sidebar menu dengan tampilan vertikal
with st.sidebar:
    st.markdown(
        '<h1 style="color: white;">☰ PREMIER INSIGHT</h1>', 
        unsafe_allow_html=True
    )  
    selected = option_menu(
        menu_title=None, 
        options=["Home", "Fixtures", "Club", "Players", "Injured Players", "Results", "Standings"], 
        icons=["house-door", "calendar", "shield", "person", "exclamation-triangle", "file-earmark", "bar-chart"], 
        menu_icon="list",  
        default_index=0,
